"""Service for proposal generation using fine-tuned model."""
import os
import torch
...
class ProposalModelService:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            cls._instance = super(ProposalModelService, cls).__new__(cls)
    ...
    def _get_model_path(self) -> str:
        ...
        model_path = os.path.join(
            base_dir,
            "materials",
            "proposal generator datasets-20251207T102310Z-3-001",
